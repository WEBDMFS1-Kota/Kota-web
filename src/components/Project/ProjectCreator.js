  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 mt-10 px-10 pb-10">
      <div className="col-span-1">
        <img className="border-2 border-black rounded-full h-36 md:h-24 w-36 md:w-24 object-cover mx-auto md:mx-0" src={projectCreator.avatar || `${process.env.PUBLIC_URL}/default-avatar.jpg`} alt="avatar" />
      </div>
