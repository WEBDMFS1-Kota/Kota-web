...
function Navbar() {
  ...
  function dropdownItemClick(path) {
    ...
    <div className="rounded-none shadow-xl bg-gray-400 dark:bg-gray-700 flex justify-between w-full p-2 items-center text-black dark:text-white">
      ...
      }
      {
        isLogged
          && (
          <div aria-label="toggler" className="flex justify-center items-center">
            <div className=" relative inline-block text-left dropdown" id="dropdownMenu">
              <button
              ...
              <div className="opacity-0 invisible dropdown-menu transition-all duration-300 transform origin-top-right -translate-y-2 scale-95">
                <div className="absolute right-0 w-56 mt-2 origin-top-right bg-gray-400 dark:bg-gray-900 border border-gray-600 divide-y divide-gray-500 rounded-md shadow-lg outline-none" aria-labelledby="headlessui-menu-button-1" id="headlessui-menu-items-117" role="menu">
                  <div className="py-1">
                    <button type="button" onClick={() => dropdownItemClick(`/user/${userID}`)} className="flex justify-between w-full px-4 py-2 text-sm leading-5 text-left hover:bg-gray-500 hover:dark:bg-gray-700 hover:text-white" role="menuitem">View profile</button>
                    <button type="button" onClick={() => dropdownItemClick('userSettings')} className="flex justify-between w-full px-4 py-2 text-sm leading-5 text-left hover:bg-gray-500 hover:dark:bg-gray-700 hover:text-white" role="menuitem">Account settings</button>
                  </div>
                  <div className="py-1">
