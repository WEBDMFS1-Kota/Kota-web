    ...
    <div className="grid grid-cols-1 my-2 mx-0 md:mx-12 justify-items-center">
      <div className="bg-gray-400 dark:bg-gray-700 text-black dark:text-white w-full md:w-96 rounded-lg overflow-hidden shadow-xl my-2">
        <div className="px-6 py-4">
          ...
          <div className="h-8 bg-slate-600 dark:bg-slate-800 w-1/2 mb-2 animate-pulse" />
          <div className="h-4 bg-slate-600 dark:bg-slate-800 animate-pulse" />
          <div className="h-4 bg-slate-600 dark:bg-slate-800 w-3/4 animate-pulse" />
        </div>
        <div className="flex px-6 py-4">
          <button type="button" className=" rounded-xl hover:bg-gray-600 py-1.5 px-2.5">
            <div className="grid grid-cols-2">
              ...
              <div className="h-4 bg-slate-600 dark:bg-slate-800 animate-pulse my-auto" />
            </div>
          </button>
          <button type="button" className="rounded-xl hover:dark:bg-gray-600 py-1.5 px-2.5">
            <div className="grid grid-cols-2">
